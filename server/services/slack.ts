namespace SlackHelper {
    ...
    module.exports = ({controller, database, bot}) => {
        ...
        const constructAnnouncement = (response, convo) => {
        ...
        const _createAuthorization = () => {
            ...
            return cachedAuth = authorization;
        }

        const _invokeCalendarUpdate = (cb) => {
            const authorization = _createAuthorization();
            const options = { 
                method: 'POST',
